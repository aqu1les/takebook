...
export default function SuccessFeedback({ children, isVisible, handleModalHide }) {
    return (
        <Modal style={Styles.Modal} isVisible={isVisible} animationIn='zoomIn' animationOut='zoomOut'>
            <View style={Styles.ModalCard}>
                <LottieView source={OkAnimation} autoPlay loop={false} style={{ width: 150, height: 150 }} />
                <TouchableOpacity
